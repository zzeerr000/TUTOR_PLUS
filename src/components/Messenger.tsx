            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between">
                    <span
                      className={`text-sm truncate ${chat.isNew ? "text-gray-500 italic" : "text-gray-400"}`}
                    >
                      {chat.lastMessage}
                    </span>
                    {chat.unread > 0 && (
                      <span className="ml-2 bg-[#1db954] text-white text-xs rounded-full w-5 h-5 flex items-center justify-center shrink-0">
                        {chat.unread}
                      </span>
                    )}
                  </div>
                  ...
                  <React.Fragment key={msg.id || index}>
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={`text-xs mt-1 ${msg.sent ? "text-white/70" : "text-gray-400"}`}
                        >
                          {msg.time}
                        </div>
                      </div>
