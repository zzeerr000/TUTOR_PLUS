...
import { GenericContainer, Network, StartedTestContainer, Wait } from 'npm:testcontainers@^8.5.1'
import { ExecResult } from 'npm:testcontainers@^8.5.1/dist/docker/types'
